    ...
    with gr.Row():
        ...
        with gr.Column(scale=1):
            ...
            warning_msg = gr.Markdown(
                "⚠️ <span style='color: #E58383;'>Рекомендуем открывать итоговый PDF-файл именно в программе Adobe Acrobat Reader.<br>В браузерах возможны проблемы с отображением аннотаций!</span>",
